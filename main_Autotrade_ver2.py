...
def buy_coin(ticker):
    ...
    print(coin_num)
    print(corrent_num)
    print(corrent_num*coin_num)
    if (target_price < current_price) and ((corrent_num*coin_num)<5000): 
        krw = get_balance("KRW")
        if krw > 5000:
...
while True:
    ...
    coins=["KRW-DAWN","KRW-XRP","KRW-BTT","KRW-DOGE","KRW-VET","KRW-BTC","KRW-ETC","KRW-ETH","KRW-BTG","KRW-STRK","KRW-MED","KRW-MVL","KRW-CHZ","KRW-AXS","KRW-BCHA","KRW-NEO","KRW-MANA"]
    try:
